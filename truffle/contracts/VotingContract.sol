...
contract VotingContract {
     ...
     * @return hasVoted_ True if voter has voted
     */
    function hasVoted(string memory electionId, address voter) 
        public 
        view 
        electionExists(electionId) 
        returns (bool hasVoted_) 
    {
     ...
     * @param electionId Election identifier
     * @return id_ The election ID
     * @return title_ The election title
     * @return startTime_ The start time
     * @return endTime_ The end time
     * @return isActive_ Whether the election is active
     * @return totalVotes_ Total number of votes cast
     * @return creator_ Address of the election creator
     */
     ...
     * @return electionId_ The election ID
     * @return timestamp_ Time when the vote was cast
     * @return voter_ Address of the voter
     * @return isValid_ Whether the vote is valid
     */
    function getVote(bytes32 voteHash) 
        public 
        view 
        returns (
            string memory electionId_,
            uint256 timestamp_,
            address voter_,
            bool isValid_
        ) 
